...
ActiveRecord::Schema.define(version: 20140909141135) do
  ...
  create_table "class_monitors", force: true do |t|
    t.string   "name"
    t.string   "email"
    t.integer  "place_id"
    t.datetime "created_at"
  ...
  add_index "class_monitors", ["place_id"], name: "index_class_monitors_on_place_id"
  ...
  create_table "user_sectors", force: true do |t|
    t.integer "sector_id"
    t.integer "user_id"
  end
