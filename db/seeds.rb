...
Reservation.create(user_id: 5, reason: "Reunião.", date: DateTime.now + 1.day, begin_time: DateTime.now, end_time: DateTime.now + 5.hour, place_id:1)
Reservation.create(user_id: 6, reason: "Reunião.", date: DateTime.now + 1.day, begin_time: DateTime.now, end_time: DateTime.now + 6.hour, place_id:1)
Reservation.create(user_id: 5, reason: "Reunião.", date: DateTime.now + 1.day, begin_time: DateTime.now, end_time: DateTime.now + 2.hour, place_id:1)
Reservation.create(user_id: 6, reason: "Reunião.", date: DateTime.now + 1.day, begin_time: DateTime.now, end_time: DateTime.now + 1.hour, place_id:1)
Reservation.create(user_id: 5, reason: "Reunião.", date: DateTime.now + 1.day, begin_time: DateTime.now, end_time: DateTime.now + 2.hour, place_id:1)
Reservation.create(user_id: 6, reason: "Reunião.", date: DateTime.now + 1.day, begin_time: DateTime.now, end_time: DateTime.now + 3.hour, place_id:1)
