...
Reservation.create(user_id: 5, reason: "Minicurso.", begin_time: DateTime.now, end_time: DateTime.now + 1.hour, place_id:1)
Reservation.create(user_id: 6, reason: "Minicurso.", begin_time: DateTime.now, end_time: DateTime.now + 2.hour, place_id:1)
Reservation.create(user_id: 6, reason: "Palestra.", begin_time: DateTime.now, end_time: DateTime.now + 3.hour, place_id:1)
Reservation.create(user_id: 5, reason: "Palestra.", begin_time: DateTime.now, end_time: DateTime.now + 4.hour, place_id:1)
Reservation.create(user_id: 5, reason: "Reunião.", begin_time: DateTime.now, end_time: DateTime.now + 5.hour, place_id:1)
Reservation.create(user_id: 6, reason: "Reunião.", begin_time: DateTime.now, end_time: DateTime.now + 6.hour, place_id:1)
Reservation.create(user_id: 5, reason: "Reunião.", begin_time: DateTime.now, end_time: DateTime.now + 2.hour, place_id:1)
Reservation.create(user_id: 6, reason: "Reunião.", begin_time: DateTime.now, end_time: DateTime.now + 1.hour, place_id:1)
Reservation.create(user_id: 5, reason: "Reunião.", begin_time: DateTime.now, end_time: DateTime.now + 2.hour, place_id:1)
Reservation.create(user_id: 6, reason: "Reunião.", begin_time: DateTime.now, end_time: DateTime.now + 3.hour, place_id:1)
